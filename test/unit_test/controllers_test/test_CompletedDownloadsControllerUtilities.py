...
from controllers import CompletedDownloadsControllerUtilities
from test.unit_test.controllers_test.test_CompletedDownloadsController import FakeFileSystemItem
...
class TestCompletedDownloadsControllerUtilities(unittest.TestCase):
    ...
    def test_downloadWasInitiatedByMediaGrab(self):
        ...
        for value in passingValues:
            success = CompletedDownloadsControllerUtilities.downloadWasInitiatedByMediaGrab(
                value)
    ...
    def test_extractShowNameMediaGrabDownload(self, downloadWasInitiatedByMediaGrabMock):
        ...
        actualFakeShowName = CompletedDownloadsControllerUtilities.extractShowName(
            fakeShowName)
        self.assertEqual(expectedFakeShowName, actualFakeShowName)

        # check empty string
        self.assertEqual(
            None, CompletedDownloadsControllerUtilities.extractShowName(""))
    ...
    def test_extractSeasonNumberMediaGrabDownload(self, downloadWasInitiatedByMediaGrabMock):
        ...
        actualFakeSeasonNumber = CompletedDownloadsControllerUtilities.extractSeasonNumber(
            fakeShowName)
        self.assertEqual(expectedSeasonNumber, actualFakeSeasonNumber)

        # check empty string
        self.assertEqual(
            None, CompletedDownloadsControllerUtilities.extractSeasonNumber(""))
    ...
    def test_extractEpisodeNumberMediaGrabDownload(self, downloadWasInitiatedByMediaGrabMock):
        ...
        actualFakeSeasonNumber = CompletedDownloadsControllerUtilities.extractEpisodeNumber(
            fakeShowName)
        self.assertEqual(expectedSeasonNumber, actualFakeSeasonNumber)
    ...
    def test_extractExtension(self):
        ...
        for fileName in testFileNames:
            actualExtension = CompletedDownloadsControllerUtilities.extractExtension(
                fileName)
    ...
    def test_reportItemAlreadyExists(self, reportErrorMock):
        ...
        CompletedDownloadsControllerUtilities.reportItemAlreadyExists(
    ...
    def test_getLargestItemInDir(self, osScandirMock, osGetsizeMock, loggingInfoMock):
        ...
        actualLargestItemInDir = CompletedDownloadsControllerUtilities.getLargestItemInDir(
            fakeDirectory)
    ...
    def test_ensureDirStructureExists(self, directoryExistsMock, createDirectoryMock, reportErrorMock):
        ...
        # call testable function - run 1
        operationSuccess = CompletedDownloadsControllerUtilities.ensureDirStructureExists(
